...
from paradicms_etl.lib.pipeline._extractor import _Extractor
from paradicms_etl.lib.pipeline._loader import _Loader
from paradicms_etl.lib.pipeline._transformer import _Transformer
from paradicms_etl.lib.pipeline.default_loader import DefaultLoader
...
class _Pipeline(ABC):
    ...
    def main(cls, args=None):
        ...
        from paradicms_etl.lib.pipeline.pipeline_wrapper import PipelineWrapper
