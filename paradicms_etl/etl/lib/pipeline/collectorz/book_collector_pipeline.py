...
from paradicms_etl.lib.pipeline.collectorz.book_collector_extractor import BookCollectorExtractor
from paradicms_etl.lib.pipeline.collectorz.book_collector_transformer import BookCollectorTransformer
