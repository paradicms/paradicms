...
class PropertyDefinitions:
    ...
    CONTRIBUTOR = PropertyDefinition(faceted=True, key="contributor", label_plural="Contributors", label_singular="Contributor", uri=DCTERMS.contributor)
    COVERAGE = PropertyDefinition(faceted=True, key="coverage", label_plural="Coverages", label_singular="Coverage", uri=DCTERMS.coverage)
    ...
    DATE_CREATED = PropertyDefinition(key="date_created", label_plural="Dates created", label_singular="Date created", uri=DCTERMS.dateCreated)
    DATE_SUBMITTED = PropertyDefinition(key="date_submitted", label_plural="Dates submitted", label_singular="Date submitted", uri=DCTERMS.dateSubmitted)
    ...
    FORMAT = PropertyDefinition(key="format", label_plural="Formats", label_singular="Format", uri=DCTERMS["format"])
    IDENTIFIER = PropertyDefinition(key="identifier", label_plural="Identifiers", label_singular="Identifier", uri=DCTERMS.identifier)
    IS_REFERENCED_BY = PropertyDefinition(key="is_referenced_by", label_plural="Referenced by", label_singular="Referenced by", uri=DCTERMS.isReferencedBy)
    ...
    LICENSE = PropertyDefinition(key="license", label_plural="Licenses", label_singular="License", uri=DCTERMS.license)
    ...
    REFERENCES = PropertyDefinition(key="references", label_plural="References", label_singular="References", uri=DCTERMS.references)
    RELATION = PropertyDefinition(key="relation", label_plural="Relations", label_singular="Relation", uri=DCTERMS.relation)
    RIGHTS = PropertyDefinition(key="rights", label_plural="Rights", label_singular="Rights", uri=DCTERMS.rights)
    RIGHTS_HOLDER = PropertyDefinition(key="rights_holder", label_plural="Rights holders", label_singular="Rights holder", uri=DCTERMS.rightsHolder)
