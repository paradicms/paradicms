...
class RightsStatementsDotOrgRightsStatements(_ModelSingletons):
    ...
    CNE = RightsStatement.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/CNE/1.0/')))
    ...
    InC_EDU = RightsStatement.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix paradicms: <http://www.paradicms.org/ns#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/InC-EDU/1.0/')))
    ...
    InC_NC = RightsStatement.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix paradicms: <http://www.paradicms.org/ns#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/InC-NC/1.0/')))
    ...
    InC_OW_EU = RightsStatement.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix paradicms: <http://www.paradicms.org/ns#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/InC-OW-EU/1.0/')))
    ...
    InC_RUU = RightsStatement.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix paradicms: <http://www.paradicms.org/ns#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/InC-RUU/1.0/')))
    ...
    InC = RightsStatement.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix paradicms: <http://www.paradicms.org/ns#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/InC/1.0/')))
    ...
    NKC = RightsStatement.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix paradicms: <http://www.paradicms.org/ns#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/NKC/1.0/')))
    ...
    NoC_CR = RightsStatement.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix paradicms: <http://www.paradicms.org/ns#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/NoC-CR/1.0/')))
    ...
    NoC_NC = RightsStatement.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix paradicms: <http://www.paradicms.org/ns#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/NoC-NC/1.0/')))
    ...
    NoC_OKLR = RightsStatement.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix paradicms: <http://www.paradicms.org/ns#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/NoC-OKLR/1.0/')))
    ...
    NoC_US = RightsStatement.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix paradicms: <http://www.paradicms.org/ns#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/NoC-US/1.0/')))
    ...
    UND = RightsStatement.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix paradicms: <http://www.paradicms.org/ns#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/UND/1.0/')))
    ...
    collection_ic = RightsStatement.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix paradicms: <http://www.paradicms.org/ns#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/collection-ic/1.0/')))
    ...
    collection_nc = RightsStatement.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix paradicms: <http://www.paradicms.org/ns#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/collection-nc/1.0/')))
    ...
    collection_other = RightsStatement.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix paradicms: <http://www.paradicms.org/ns#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
