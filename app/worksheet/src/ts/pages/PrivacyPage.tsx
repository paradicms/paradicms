...
export const PrivacyPage: React.FunctionComponent = () => (
  <Frame>
    <Container fluid>
      <Row>
        <Col md="12">
          <h4 className="mt-2 pb-2 pl-4 pt-2 text-center">Privacy</h4>
        </Col>
      </Row>
      <Row />
      <Row>
            ...
            <CardBody>
              <Container fluid>
                <p>
                  ...
                  DressDiscover (https://dressdiscover.org). This privacy notice
                ...
                <p>
                  Wherever we collect sensitive information such as your account
                  password, that information is encrypted and transmitted to us
                  in a secure way. You can verify this by looking for a lock
                  icon in the address bar and looking for "https" at the
                ...
                <p>
                  ...
                  you should&nbsp;
                  <a href={Hrefs.contact}>contact us immediately</a>.
                </p>
              </Container>{" "}
            </CardBody>
          </Card>
