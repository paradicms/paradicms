  ...
  return (
    ...
    >
      ...
      <p className="card-text">
        Select one or more feature sets to describe the object. Currently the
        feature set for a Dress is the only one available, but more will be
        added in the future.
      </p>
                ...
                {featureSet.features.map((feature, featureIndex) => (
                  <React.Fragment key={feature.uri}>
                    <span
                      ...
                      style={{
                        fontWeight: featureIndex % 2 === 0 ? "bold" : "normal",
                      }}
                    >
