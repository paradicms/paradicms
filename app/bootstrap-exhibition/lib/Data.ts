import fs from "fs";
import {Collection, Configuration, Image, Institution, Object} from "@paradicms/models";
...
export class Data {
  constructor() {
    ...
    const allData = new RdfData(RdfData.parseTurtle(fs.readFileSync(dataTtlFilePath).toString()));
