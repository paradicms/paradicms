...
class RightsStatementsDotOrgRightsStatements(ModelSingletons):
    ...
    CNE = _MODEL_CLASS.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/CNE/1.0/')))
    ...
    InC_EDU = _MODEL_CLASS.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/InC-EDU/1.0/')))
    ...
    InC_NC = _MODEL_CLASS.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .

<http://rightsstatements.org/vocab/InC-NC/1.0/> a dcterms:RightsStatement ;
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/InC-NC/1.0/')))
    ...
    InC_OW_EU = _MODEL_CLASS.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .

<http://rightsstatements.org/vocab/InC-OW-EU/1.0/> a dcterms:RightsStatement ;
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/InC-OW-EU/1.0/')))
    ...
    InC_RUU = _MODEL_CLASS.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .

<http://rightsstatements.org/vocab/InC-RUU/1.0/> a dcterms:RightsStatement ;
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/InC-RUU/1.0/')))
    ...
    InC = _MODEL_CLASS.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .

<http://rightsstatements.org/vocab/InC/1.0/> a dcterms:RightsStatement ;
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/InC/1.0/')))
    ...
    NKC = _MODEL_CLASS.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .

<http://rightsstatements.org/vocab/NKC/1.0/> a dcterms:RightsStatement ;
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/NKC/1.0/')))
    ...
    NoC_CR = _MODEL_CLASS.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .

<http://rightsstatements.org/vocab/NoC-CR/1.0/> a dcterms:RightsStatement ;
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/NoC-CR/1.0/')))
    ...
    NoC_NC = _MODEL_CLASS.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .

<http://rightsstatements.org/vocab/NoC-NC/1.0/> a dcterms:RightsStatement ;
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/NoC-NC/1.0/')))
    ...
    NoC_OKLR = _MODEL_CLASS.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .

<http://rightsstatements.org/vocab/NoC-OKLR/1.0/> a dcterms:RightsStatement ;
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/NoC-OKLR/1.0/')))
    ...
    NoC_US = _MODEL_CLASS.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .

<http://rightsstatements.org/vocab/NoC-US/1.0/> a dcterms:RightsStatement ;
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/NoC-US/1.0/')))
    ...
    UND = _MODEL_CLASS.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .

<http://rightsstatements.org/vocab/UND/1.0/> a dcterms:RightsStatement ;
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/UND/1.0/')))
    ...
    collection_ic = _MODEL_CLASS.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .

<http://rightsstatements.org/vocab/collection-ic/1.0/> a dcterms:RightsStatement ;
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/collection-ic/1.0/')))
    ...
    collection_nc = _MODEL_CLASS.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .

<http://rightsstatements.org/vocab/collection-nc/1.0/> a dcterms:RightsStatement ;
...
''', format='ttl').resource(URIRef('http://rightsstatements.org/vocab/collection-nc/1.0/')))
    ...
    collection_other = _MODEL_CLASS.from_rdf(Graph().parse(data=r'''@prefix dcterms: <http://purl.org/dc/terms/> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .

<http://rightsstatements.org/vocab/collection-other/1.0/> a dcterms:RightsStatement ;
