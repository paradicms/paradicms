...
class Event(ResourceBackedNamedModel):
    ...
    class Builder(ResourceBackedNamedModel.Builder):
        def set_date(self, date: DateTimeUnion) -> "Builder":
        ...
        def set_end_date(self, end_date: DateTimeUnion) -> "Builder":
            self.set(VRA.endDate, end_date)
            return self

        def set_location(self, location: Union[str, Location]) -> "Builder":
            self.set(DCTERMS.spatial, location)
            return self

        def set_start_date(self, start_date: DateTimeUnion) -> "Builder":
