...
describe("Institution overview", () => {
  ...
  it("should show the institution name in the frame", () => {
    page.frame.cardTitle.should("have.text", TestData.institution.name + " - Collections");
  });
  ...
  it("should have a collection link that leads to the collection overview page", () => {
    const kwds = {collectionUri: TestData.collection.uri, institutionUri: TestData.institution.uri};
