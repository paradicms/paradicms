import {CollectionOverviewQuery_collectionByUri_rights} from "paradicms/gui/core/api/queries/types/CollectionOverviewQuery";
import {Uris} from "paradicms/gui/core/util/Uris";
